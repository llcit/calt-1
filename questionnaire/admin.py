...
adminsite.register(Language, LanguageAdmin)
adminsite.register(Question, QuestionAdmin, Media=TextMedia)
adminsite.register(Questionnaire, QuestionnaireAdmin)
adminsite.register(QuestionSet, QuestionSetAdmin, Media=TextMedia)
