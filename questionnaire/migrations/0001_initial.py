    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(max_length=64, verbose_name='Short Value', blank=True)),
                ('text_en', models.CharField(max_length=200, null=True, verbose_name='Choice Text', blank=True)),
                ('extra_text', models.CharField(max_length=200, verbose_name='Choice Text', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_text', models.TextField(verbose_name='Text', blank=True)),
                ('image', models.FileField(upload_to=b'img', blank=True)),
                ...
                ('footer_en', models.TextField(help_text=b'Footer rendered below the question interpreted as textile', null=True, verbose_name='Footer', blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(to='questionnaire.Language')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_en', models.TextField(help_text=b"This is interpreted as Textile: <a href='http://en.wikipedia.org/wiki/Textile_%28markup_language%29' target='_blank'>http://en.wikipedia.org/wiki/Textile_(markup_language)</a>", null=True, verbose_name='Text', blank=True)),
                ('audio', models.FileField(null=True, upload_to=b'audio', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(default=b'en-us', max_length=2, verbose_name='Language', choices=[(b'en', b'English')])),
            ],
            options={
            },
            bases=(models.Model,),
