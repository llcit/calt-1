...
class Subject(models.Model):
    ...
    account=models.ForeignKey(User, unique=True, blank=False)
    ...
    def create_subject(sender, instance, created, **kwargs):
        if created:
            Subject.objects.create(account=instance, surname=instance.username)
            
    post_save.connect(create_subject, sender=User)
...
class Question(models.Model):
    ...
    extra_text = models.TextField(blank=True, verbose_name=_("Text"))
...
class Choice(models.Model):
    ...
    value = models.CharField(u"Short Value", blank=True,    max_length=64)
    text = models.CharField(u"Choice Text", max_length=200)
    extra_text = models.CharField(u"Choice Text", blank=True, max_length=200)
...
class MediaUrl(models.Model):
    ...
    name_file= models.CharField(max_length=250, blank=True, null=True)
